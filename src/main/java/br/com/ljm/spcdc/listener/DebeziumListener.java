package br.com.ljm.spcdc.listener;

import br.com.ljm.spcdc.service.CustomerService;
...
public class DebeziumListener {
    ...
    final static Logger logger = LoggerFactory.getLogger(DebeziumListener.class);
